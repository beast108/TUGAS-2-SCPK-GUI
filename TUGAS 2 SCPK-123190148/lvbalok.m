...
% Last Modified by GUIDE v2.5 08-Apr-2021 01:43:32
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
input1=get(handles.edit1,'string');%mengambil nilai panjang pada edit1
input2=get(handles.edit2,'string');%mengambil nilai lebar pada edit2
input3=get(handles.edit3,'string');%mengambil nilai tinggi pada edit3
angka1=str2num(input1);%mengubah string menjadi number
angka2=str2num(input2);
angka3=str2num(input3);
hasil=2*((angka1*angka2)+(angka1*angka3)+(angka2*angka3)); %proses perhitungan luas
hasil=num2str(hasil); 
set(handles.edit4,'string',(hasil)); %menampilkan hasil
...
angka2=str2num(input2);
angka3=str2num(input3);
hasil=angka1*angka2*angka3; %proses perhitungan volume
hasil=num2str(hasil); 
set(handles.edit5,'string',(hasil)); %menampilkan hasil
