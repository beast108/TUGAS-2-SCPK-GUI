...
% Last Modified by GUIDE v2.5 08-Apr-2021 02:43:25
...
if mod(angka1,4)==0
    set(handles.edit2,'string',('Tahun Kabisat'));
elseif mod(angka1,100)==0 && mod(tahun1,400)==0
    set(handles.edit2,'string',('Tahun Kabisat'));
else
	set(handles.edit2,'string',('Bukan Tahun Kabisat'));
end
